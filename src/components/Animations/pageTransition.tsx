...
export const PageTransition = () => {
  return (
    <Fragment>
      ...
      <motion.div
        className="fixed top-0 bottom-0 right-full w-screen h-screen z-30 bg-[#0f2756]"
      ...
      <motion.div
        className="fixed top-0 bottom-0 right-full w-screen h-screen z-20 bg-[#0B1D29] "
        initial={{ x: '100%', width: '100%' }}
        animate={{ x: '0%', width: '0%' }}
      ...
      <motion.div
        className="fixed top-0 bottom-0 right-full w-screen h-screen z-10 bg-slate-300"
        initial={{ x: '100%', width: '100%' }}
        animate={{ x: '0%', width: '0%' }}
